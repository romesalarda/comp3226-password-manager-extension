...
// Build nonce injection content script
await esbuild
  .build({
    ...buildOptions,
    entryPoints: ["src/nonce_injection/content.js"],
    outfile: "nonce_injection/content.js",
  })
  .catch(() => process.exit(1));

// Build nonce injection page script
await esbuild
  .build({
    ...buildOptions,
    entryPoints: ["src/nonce_injection/injected.js"],
    outfile: "nonce_injection/injected.js",
  })
  .catch(() => process.exit(1));
