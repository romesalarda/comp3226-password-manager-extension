// Injected script to execute OPAQUE login in page context
// This script runs in the page context and has access to imported modules

window.addEventListener('message', async (event) => {
  // Only accept messages from same window
  if (event.source !== window) return;
  
  // Check if this is an OPAQUE login request
